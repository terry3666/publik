...
import time, random, sys, ast, re, os, io, json, subprocess, threading, string,$
...
kc = LineAlpha.LINE()
kc.login(token="Eo0fSWvsWt0qal1dFA50.SIIDQHB+PWCP2bXYI9JK8a.6xID5b/UmwSxXbqYE52ErHw7WK5N5NcESTSo4jbfapg=")
kc.loginResult()
